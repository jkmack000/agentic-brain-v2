# LEARN-036 — LLM Code Generation Patterns for Trading Strategies
<!-- type: LEARN -->
<!-- tags: code-generation, LLM, trading, validation, security, sandbox, prompting, few-shot, SCoT, competitive-analysis, coder-brain -->
<!-- created: 2026-02-17 -->
<!-- source: Subagent web research across 27+ academic papers and open-source projects, recovered from session 3591f34c chat log review -->
<!-- links: SPEC-002, SPEC-001, LEARN-035, LEARN-025 -->

## Purpose

Quantitative research synthesis on LLM code generation patterns, validation toolchains, and security sandboxing — specifically for AI-generated trading strategies. Informs the Coder brain write pipeline (SPEC-002).
...
This is the empirical justification for the Coder brain's knowledge-first architecture (SPEC-002): pre-ingested framework knowledge eliminates the largest error class.
...
## Template-Based Generation (Recommended for Coder Brain)
