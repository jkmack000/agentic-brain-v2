# LEARN-035 — Freqtrade IStrategy Technical Reference
<!-- type: LEARN -->
<!-- tags: freqtrade, IStrategy, trading, code-generation, python, callbacks, hyperopt, signals, coder-brain -->
<!-- created: 2026-02-17 -->
<!-- source: Subagent web research across 12+ Freqtrade documentation pages (freqtrade.io), recovered from session 3591f34c chat log review -->
<!-- links: SPEC-002, SPEC-001, LEARN-025 -->

## Purpose

Complete technical reference for Freqtrade's IStrategy interface — the target abstraction for AI-generated trading strategies. This is the seed knowledge for the Coder brain's planned LEARN-001 (SPEC-002 Phase 1 ingestion).
